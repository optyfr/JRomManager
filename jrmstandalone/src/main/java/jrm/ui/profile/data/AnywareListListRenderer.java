...
public final class AnywareListListRenderer {
    ...
    protected static final String[] columns = new String[] { Messages.getString("SoftwareListListRenderer.Name"), Messages.getString("SoftwareListListRenderer.Description"), //$NON-NLS-1$ //$NON-NLS-2$
            Messages.getString("SoftwareListListRenderer.Have") }; //$NON-NLS-1$

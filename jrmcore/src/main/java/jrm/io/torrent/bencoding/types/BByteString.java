...
/**
 * Representation of a bencoded byte string. Consists of an arbitrary sequence
 * of bytes, which may or may not be ASCII printable.
 *
...
public class BByteString implements IBencodable {
    ...
    /**
     * Constructs a BByteString by converting a standard Java String into its
    ...
    /**
     * Returns the bencoded string format of this byte string. Format:
     * {@code <length>:<data>} (e.g., "4:spam").
     *
    ...
    /**
     * Encodes this byte string into the standard bencoded byte array format.
     * Consists of the length string in ASCII, followed by ':' and the raw bytes.
     *
    ...
    /**
     * Returns a readable string representation. If the contents are entirely
     * printable ASCII, it is returned directly; otherwise, a placeholder showing
     ...
     * @return {@code true} if the other object is a BByteString containing
     *         identical bytes, otherwise {@code false}
     */
    @Override
    ...
    /**
     * Returns the hash code value for this BByteString, based on its byte array
     * contents.
     *

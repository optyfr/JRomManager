 ...
 * Extracts both MD5 and SHA-1 checksums at the offsets specified by version 3 of the format.
 * 
 * @author optyfr
 */
...
{
	/**
	 * Constructs a CHD version 3 header parser, copying core tag/length/version properties

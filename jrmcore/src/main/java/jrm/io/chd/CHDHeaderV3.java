...
/**
 * Concrete implementation of the CHD file header parser for CHD version 3. Extracts both MD5 and SHA-1 checksums at the offsets
 * specified by version 3 of the format.
 * 
 * @author optyfr
 */
class CHDHeaderV3 extends CHDHeaderSHA1 {
    /**
     * Constructs a CHD version 3 header parser, copying core tag/length/version properties from a base parsed CHD header and

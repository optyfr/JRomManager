...
/**
 * An intermediate representation of CHD file headers that include both MD5 and SHA-1 checksums. Inherits MD5 storage from
 * {@link CHDHeaderMD5} and adds storage and retrieval methods for the SHA-1 digest.
 * 
 * @author optyfr
 */
class CHDHeaderSHA1 extends CHDHeaderMD5 {
    ...
    /**
     * Retrieves the SHA-1 digest of the raw, uncompressed data represented by this CHD, as parsed from the header.
     *

...
/**
 * Concrete implementation of the CHD file header parser for CHD version 1. Extract MD5 checksums at the offset specified by version
 * 1 of the format.
 * 
 * @author optyfr
 */
class CHDHeaderV1 extends CHDHeaderMD5 {
    /**
     * Constructs a CHD version 1 header parser, copying core tag/length/version properties from a base parsed CHD header and

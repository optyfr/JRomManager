...
/**
 * An intermediate representation of CHD file headers that include an MD5 checksum. Provides storage and retrieval methods for the
 * MD5 digest of the raw, uncompressed data.
 * 
 * @author optyfr
 */
class CHDHeaderMD5 extends CHDHeader {
    ...
    /**
     * Retrieves the MD5 digest of the raw, uncompressed data represented by this CHD, as parsed from the header.
     *

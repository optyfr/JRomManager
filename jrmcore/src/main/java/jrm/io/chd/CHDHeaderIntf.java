...
/**
 * Unified interface for accessing metadata, structural details, and cryptographic checksums extracted from different versions of
 * CHD (Compressed Hunks of Data) file headers.
 * 
 * @author optyfr
 */

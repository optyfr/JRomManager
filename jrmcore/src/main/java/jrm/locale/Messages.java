 ...
 * for all textual content across the application. It dynamically selects the bundle 
 * based on the active or system Locale, or a design-time context.
 * 
 * @author optyfr
 */
public class Messages {
	...
	/**
	 * Translates/retrieves the localized string value associated with the specified key.
	 * If the key is not found, wraps the key name in exclamation marks.
	 *

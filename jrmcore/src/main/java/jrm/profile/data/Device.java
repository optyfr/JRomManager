...
/**
 * Represents a device belonging to a {@link Machine}, providing details about
 * its type, tags, matching interfaces, instance characteristics, and supported
 * media extensions.
 *
 * @author optyfr
 */
...
public final class Device implements Serializable {
    ...
    /**
     * Indicates if the device supports a fixed/permanent image or acts as a media
     * switch (typically "1" or {@code null}).
     *
    ...
    /**
     * Specifies whether this device is mandatory for the machine's operation
     * (commonly "1" or {@code null}).
     *
    ...
    /**
     * The {@link Instance} details representing the active implementation of this
     * device.
     *

 ...
 * <p>
 * This class implements the {@link java.util.List} interface by delegating all operations
 * to an underlying {@link java.util.ArrayList}. It provides a reusable base for specific types
 * of game lists, such as category listings or player mode listings.
 * </p>
 * 
 * @author optyfr
 * @since 1.0
...
abstract class GamesList implements List<String>
{
	...
	/**
	 * Returns the index of the first occurrence of the specified game code name in this list,
	...
	/**
	 * Returns the index of the last occurrence of the specified game code name in this list,
	 * or -1 if this list does not contain the element.
	 * 
	 * @param o element to search for

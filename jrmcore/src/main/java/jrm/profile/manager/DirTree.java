...
/**
 * Models a tree structure of filesystem directories.
 * Extends the generic {@link Tree} container with {@link Dir} elements to allow
...
{
	/**
	 * Constructs a new directory tree with a specified root directory node
	 * without performing recursive scanning.
	 * 
	...
	/**
	 * Constructs a new directory tree starting from a physical filesystem root folder.
	 * This triggers a recursive filesystem discovery to build the complete node hierarchy.
	 * 
	...
	/**
	 * Recursively scans the filesystem for directories starting from the given node,
	 * attaching any discovered subdirectories as child nodes in the tree structure.
	 * 

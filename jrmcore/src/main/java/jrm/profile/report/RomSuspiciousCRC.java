 ...
 * <p>
 * A suspicious CRC checksum occurs when two distinct file entries share an identical CRC32 value
 * but have conflicting high-security cryptographic hashes (MD5 or SHA-1), signaling potential collisions or errors.
 *
 * @author optyfr
 * @since 1.0
 */

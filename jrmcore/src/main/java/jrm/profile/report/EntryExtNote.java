 ...
 * <p>
 * This class provides standard accessors and formatting helpers to output details, name resolutions,
 * and expected checksum matches for specific entry types.
 *
 * @author optyfr
 * @since 1.0
 */

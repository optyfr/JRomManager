...
/**
 * Report note indicating that a required expected metadata entity is missing, but can be duplicated
 * from another matching physical entry located inside the same container.
 * <p>

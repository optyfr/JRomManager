 ...
 * <p>
 * This status indicates that the physical file or folder matches a known game or romset, but is not selected or required
 * by the active configuration profile settings.
 *
 * @author optyfr
 * @since 1.0
 */

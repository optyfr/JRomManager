...
/**
 * Exporter class that walks a physical directory, scans its ROM and CHD contents,
 * and serializes the metadata back into a standard MAME-compatible XML DAT file.
 * Supports MAME, software list, and generic database formats.
 * 
 * @author optyfr
 * @since 1.0
 */
public class Dir2Dat
{
	 ...
	 * serializes the scanned container metadata to the specified destination DAT file.
	 * 

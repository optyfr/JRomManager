...
/**
 * Enumeration of available hash collision management options. These options define the behavior of the rebuilder when identical
 * checksums (hash collisions) are detected between different romsets or parent/clone relationships.
 * 
 * @author optyfr
 * 
 * @since 1.0

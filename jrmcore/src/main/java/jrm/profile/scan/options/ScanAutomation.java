...
/**
 * Enumeration specifying different scan automation pipeline levels. These
 * levels control the automated flow of operations, including scanning folders,
 * generating a report, applying recommended repairs, and re-scanning to ensure
 * consistency.
 * 
 * @author optyfr
 * @since 1.0
...
public enum ScanAutomation implements Descriptor {
    ...
    /**
     * Perform directory scanning, generate a report, and immediately attempt to fix
     * any errors found.
     */
    SCAN_REPORT_FIX(Messages.getString("ScanAutomation.ScanReportFix")), //$NON-NLS-1$

    /**
     * Perform directory scanning, generate a report, apply repairs, and then
     * re-scan the destination.
     */
    SCAN_REPORT_FIX_SCAN(Messages.getString("ScanAutomation.ScanReportFixScan")), //$NON-NLS-1$

    /**
     * Perform directory scanning and apply repairs directly without saving a
     * persistent report.
     */
    ...
    /**
     * Checks if this automation option requires generating and storing a scan
     * report.
     * 
     ...
     * 
     * @return {@code true} if files should be modified/fixed, otherwise
     *         {@code false}.
     */
    ...
    /**
     * Checks if this automation option requires performing a secondary verification
     * scan after repairs are done.
     * 
     * @return {@code true} if a follow-up scan is specified, otherwise
     *         {@code false}.
     */

...
/**
 * Enumeration specifying different scan automation pipeline levels. These levels control the automated flow of operations,
 * including scanning folders, generating a report, applying recommended repairs, and re-scanning to ensure consistency.
 * 
 * @author optyfr
 * 
 * @since 1.0

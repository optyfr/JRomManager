...
/**
 * An exception used as a control-flow mechanism to break out of functional
 * loops or lambda expressions where standard break statements cannot be
 * utilized.
 * <p>
 * This exception extends {@link RuntimeException} to avoid checked exception
 * declarations.
 * </p>
 * 
 * @author optyfr
...
public class BreakException extends RuntimeException {
    /**
     * Constructs a new {@code BreakException} with {@code null} as its detail
     * message.
     */
    ...
    /**
     * Constructs a new {@code BreakException} with the specified detail message and
     * cause.
     * 
     * @param message the detail message of the exception
     * @param cause   the cause of the exception

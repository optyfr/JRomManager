...
/**
 * A functional interface representing an action or task to be executed on an
 * input argument. This can throw any {@link Exception} during processing,
 * allowing exception propagation.
 * 

...
public class SevenZipNArchive extends NArchive {
    ...
    /**
     * Constructs a new SevenZipNArchive instance with the specified session and archive file. This constructor initializes the
     * archive in read-write mode by default.
     * 
    ...
    /**
     * Constructs a new SevenZipNArchive instance with the specified session, archive file, and read-only flag. This constructor
     * allows for specifying whether the archive should be opened in read-only mode or not.
     * 
     * @param session the Session object representing the current user session, used for authentication and access control during
     *        archive operations
     * @param archive the File object representing the archive file to be opened and managed by this instance
    ...
    /**
     * Constructs a new SevenZipNArchive instance with the specified session, archive file, read-only flag, and progress callback.
     * This constructor allows for specifying whether the archive should be opened in read-only mode and provides a callback for

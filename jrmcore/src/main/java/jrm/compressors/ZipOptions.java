...
public enum ZipOptions {
    ...
    /** Constructs a new ZipOptions instance with the specified description and compression level. This constructor initializes the enum constant with the provided description for display purposes and the corresponding compression level for configuring the compression algorithm during archive operations.

...
/**
 * Interface defining methods for rendering status messages in various formats, such as colored labels, progress bars, and escaped strings. Implementations of this interface can provide different rendering styles for status messages, allowing for flexible and customizable output in user interfaces or logs.
 * 
 * @author optyfr
 */
interface StatusRenderer {

    /** Converts the given character sequence into a document format suitable for rendering. The specific format and styling of the resulting string will depend on the implementation of this method, allowing for different visual representations of the input text.
    ...
    /** Converts the given object into a string representation. If the input object is null, an empty string is returned. This method provides a default implementation that can be overridden by implementing classes to provide custom string representations for specific types of objects.
    ...
    /** Converts the given character sequence into a format suitable for rendering without line breaks. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it does not contain any line breaks.
    ...
    /** Converts the given character sequence into a format suitable for rendering with line breaks. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it can contain line breaks as needed.
    ...
    /** Converts the given character sequence into a format suitable for rendering with bold blue styling. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it is styled with bold blue formatting.
    ...
    /** Converts the given character sequence into a format suitable for rendering with italic blue styling. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it is styled with italic blue formatting.
    ...
    /** Converts the given character sequence into a format suitable for rendering with bold red styling. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it is styled with bold red formatting.
    ...
    /** Converts the given character sequence into a format suitable for rendering with bold green styling. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it is styled with bold green formatting.
    ...
    /** Converts the given character sequence into a format suitable for rendering with italic green styling. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it is styled with italic green formatting.
    ...
    /** Converts the given character sequence into a format suitable for rendering with bold gray styling. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it is styled with bold gray formatting.
    ...
    /** Converts the given character sequence into a format suitable for rendering with bold orange styling. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it is styled with bold orange formatting.
    ...
    /** Converts the given character sequence into a format suitable for rendering with bold purple styling. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it is styled with bold purple formatting.
    ...
    /** Converts the given character sequence into a format suitable for rendering with italic black styling. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it is styled with italic black formatting.
    ...
    /** Converts the given character sequence into a format suitable for rendering with the specified web color. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it is styled with the specified web color.
    ...
    /** Converts the given character sequence into a format suitable for rendering with the specified web color and bold styling. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it is styled with the specified web color and bold formatting.
     ...
     * @return a string representing the input character sequence in a format suitable for rendering with the specified web color and bold styling
     */
    public default String toLabel(CharSequence str, String webcolor, boolean bold) {
        return toLabel(str, webcolor, bold, false);
    }

    /** Converts the given character sequence into a format suitable for rendering with the specified web color, bold styling, and italic styling. The specific formatting applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that it is styled with the specified web color, bold formatting, and italic formatting as needed.
     * @param str the character sequence to be converted into a format with the specified web color, bold styling, and italic styling
     * @param webcolor the web color to be applied to the input character sequence (e.g., "blue", "red", "green")
     * @param bold a boolean indicating whether to apply bold styling to the input character sequence
     * @param italic a boolean indicating whether to apply italic styling to the input character sequence
     * @return a string representing the input character sequence in a format suitable for rendering with the specified web color, bold styling, and italic styling
     */
    public String toLabel(CharSequence str, String webcolor, boolean bold, boolean italic);


    /** Converts the given progress information into a string representation suitable for rendering. The specific formatting applied to the progress information will depend on the implementation of this method, allowing for different visual representations of the progress while ensuring that it conveys the current progress status effectively.
    ...
    /** Converts the given progress information into a string representation suitable for rendering, with a specified width for the progress bar. The specific formatting applied to the progress information will depend on the implementation of this method, allowing for different visual representations of the progress while ensuring that it conveys the current progress status effectively within the specified width.
     * @param width the width of the progress bar representation
     * @param i the current progress value
     * @param max the maximum progress value
     * @param msg an optional message to be included in the progress representation
     * @return a string representing the progress information in a format suitable for rendering, with a specified width for the progress bar
     */
    public String progress(int width, int i, int max, String msg);

    /** Converts the given character sequence into an escaped string representation suitable for rendering. The specific escaping applied to the input string will depend on the implementation of this method, allowing for different visual representations of the text while ensuring that any special characters are properly escaped for safe rendering.
    ...
    /** Retrieves the current document representation of the status. The specific format and content of the document will depend on the implementation of this method, allowing for different visual representations of the status information in a document format suitable for rendering.
    ...
    /** Checks whether the current status has progress information available. The specific criteria for determining whether progress information is present will depend on the implementation of this method, allowing for different ways to indicate the presence of progress information in the status representation.

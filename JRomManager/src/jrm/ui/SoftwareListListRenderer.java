...
public final class SoftwareListListRenderer
{
	...
	{
		ImageIcon disk_multiple_green = new ImageIcon(SoftwareListListRenderer.class.getResource("/jrm/resources/disk_multiple_green.png")); //$NON-NLS-1$
		ImageIcon disk_multiple_orange = new ImageIcon(SoftwareListListRenderer.class.getResource("/jrm/resources/disk_multiple_orange.png")); //$NON-NLS-1$
		ImageIcon disk_multiple_red = new ImageIcon(SoftwareListListRenderer.class.getResource("/jrm/resources/disk_multiple_red.png")); //$NON-NLS-1$
		ImageIcon disk_multiple_gray = new ImageIcon(SoftwareListListRenderer.class.getResource("/jrm/resources/disk_multiple_gray.png")); //$NON-NLS-1$

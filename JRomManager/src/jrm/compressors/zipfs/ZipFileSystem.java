...
class ZipFileSystem extends FileSystem {
                  ...
                  Map<String, ?> env) throws IOException
    {
		...
		this.readOnly = isTrue(env, "readOnly");
    ...
    private int getCompressMethod() {
         return compressionLevel==0?METHOD_STORED:METHOD_DEFLATED;
    }
            ...
            try {
                ...
                if (e != null) {
                    ...
                    SeekableByteChannel sbc =
                            new EntryOutputChannel(new Entry(e, Entry.NEW, -1));
    ...
    static class Entry extends IndexNode implements ZipFileAttributes {
        ...
        Entry(byte[] name, boolean isdir, int method) {
            ...
            this.size   = 0;
            this.csize  = 0;
            this.method = method!=0?METHOD_DEFLATED:METHOD_STORED;
        }
        ...
        Entry(Entry e, int type, int method) {
            name(e.name);
            this.isdir     = e.isdir;

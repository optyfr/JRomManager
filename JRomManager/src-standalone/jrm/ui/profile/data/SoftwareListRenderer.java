...
public final class SoftwareListRenderer
{
	...
	private final static ImageIcon folder_closed_green = new ImageIcon(SoftwareListRenderer.class.getResource("/jrm/resicons/folder_closed_green.png")); //$NON-NLS-1$
	
	/** The Constant folder_closed_orange. */
	private final static ImageIcon folder_closed_orange = new ImageIcon(SoftwareListRenderer.class.getResource("/jrm/resicons/folder_closed_orange.png")); //$NON-NLS-1$
	
	/** The Constant folder_closed_red. */
	private final static ImageIcon folder_closed_red = new ImageIcon(SoftwareListRenderer.class.getResource("/jrm/resicons/folder_closed_red.png")); //$NON-NLS-1$
	
	/** The Constant folder_closed_gray. */
	private final static ImageIcon folder_closed_gray = new ImageIcon(SoftwareListRenderer.class.getResource("/jrm/resicons/folder_closed_gray.png")); //$NON-NLS-1$

/**
 * JavaFX support types for the profile manager view.
 * <p>
 * Supplies the tree and table building blocks used by the profile management panel.
 ...
 * {@link jrm.fx.ui.profile.manager.HaveNTotalCellFactory} renders have/total statistics with color coding
 * that reflects collection completeness. Both types rely on the {@code jrmcore} profile manager model

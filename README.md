...
- MIT : Jtrrntzip (based on trrntZipDN by Gordon J), commonmark (by Atlassian)
- LGPL 2.1 with unRAR restriction : SevenZipJBinding
- Apache 2.0: StreamEx, Apache commons libraries

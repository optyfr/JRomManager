...
public enum CMD_DIRUPD8R {
    LSSRC("lssrc"), LSSDR("lssdr"), CLEARSRC("clearsrc"), CLEARSDR("clearsdr"), ADDSRC("addsrc"), ADDSDR("addsdr"), START("start"), PRESETS("presets"), SETTINGS("settings"),
    HELP("help", "?"), EMPTY(""), UNKNOWN();
